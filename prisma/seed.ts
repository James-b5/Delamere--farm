    ...
    data: [
      {
        ...
        price: 150,
        stock: 200,
        images: JSON.stringify(['https://picsum.photos/seed/tomato/400/300']),
      ...
      },
      {
        ...
        price: 80,
        stock: 150,
        images: JSON.stringify(['https://picsum.photos/seed/spinach/400/300']),
        videos: JSON.stringify([]),
        specs: JSON.stringify({ category: 'Vegetable' }),
      },
    ],
    ...
    data: [
      {
        ...
        price: 2500,
        stock: 30,
        images: JSON.stringify(['https://picsum.photos/seed/chicken/400/300']),
      ...
      },
      {
        ...
        price: 15000,
        stock: 10,
        images: JSON.stringify(['https://picsum.photos/seed/goat/400/300']),
